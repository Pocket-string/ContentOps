  ...
  return (
    <div className="space-y-8">
      ...
      <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
        ...
        <span className="text-xl font-bold text-primary-500">ContentOps</span>
      </div>

      <div className="text-center lg:text-left">
        <h1 className="text-display-xs text-foreground">Crea tu cuenta</h1>
        <p className="mt-2 text-foreground-secondary">Comienza gratis y genera contenido LinkedIn como profesional</p>
      </div>
